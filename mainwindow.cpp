...
MainWindow::MainWindow(QWidget *parent): QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(this, &MainWindow::kill_Request, receiver, &UdpReceiver::kill_Accept,  Qt::QueuedConnection);
    connect(receiver, &UdpReceiver::kill_Thread, receiving_thread, &QThread::terminate,  Qt::DirectConnection);
...
void MainWindow::Call_Sending_Thread(QString message) {
    ...
    UdpSender *send = new UdpSender(package_size, package_delay, port,rand_id, request_status,
                                    message, files_data);
    ...
    connect(send, &UdpSender::kill_Thread, sending_thread, &QThread::terminate,  Qt::DirectConnection);
