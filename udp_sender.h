...
public:
    UdpSender(std::uint64_t max_size,std::uint64_t delay, std::uint16_t port, bool request_status, QString message = nullptr, QMap<QByteArray, QByteArray> files_data = {}, QObject* parent = 0);
    ~UdpSender();
};
